...
make LDFLAGS=-static -j $nproc && cp gdbserver ~/gdbserver/$version/arm-gdbserver-$version && cd ..
...
make LDFLAGS=-static -j $nproc && cp gdbserver ~/gdbserver/$version/mips-gdbserver-$version && cd ..
...
make LDFLAGS=-static -j $nproc && cp gdbserver ~/gdbserver/$version/mipsel-gdbserver-$version && cd ..
